...
class DailyStepsWorkerProvider : WorkerProvider {
    override fun createWorker(
        ...
        return DailyStepWorker(appContext, workerParameters, workProviderDependencies.dailyStepHandler, workProviderDependencies.saveService, workProviderDependencies.sharedPreferences)
    }
}